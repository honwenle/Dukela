<template>
  <div>
    <d-header :tran="true" :theme-color="true">收益明细</d-header>
    <list
        ...
        <div
          ...
          <div class="flex-5">
            <div class="flex space-between fz16">
              ...
              <div class="cost-color cost-num">{{item.AchievementAmount}}</div>
            </div>
            <div class="flex space-between">
              <div class="gray">交易金额：{{item.Amount}}</div>
...
export default {
  computed: {
    dataList() {
      return this.$store.state.AchievementList
    }
  }
}
</script>
